gapi.load('client', () => {
    ...
    gapi.client.load('youtube', 'v3', () => {
      ...
      const videos = [
        ...
        { videoId: 'fE2h3lGlOsk', dailyViews: 120000, milestoneViews: 530000000, mainMileViews:600000000, divId: 'video5' ,NextMile:'Est. Date for 530M ~ ', NextMileMain:'Est. Date for 600M ~ '},
        { videoId: 'fE2h3lGlOsk', dailyViews: 120000, milestoneViews: 530000000, mainMileViews:600000000, divId: 'video6' ,NextMile:'Est. Date for 530M ~ ', NextMileMain:'Est. Date for 600M ~ '},
