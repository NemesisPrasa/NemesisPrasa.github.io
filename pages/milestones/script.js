gapi.load('client', () => {
    ...
    gapi.client.load('youtube', 'v3', () => {
      ...
      const videos = [
        { videoId: '0bIRwBpBcZQ', dailyViews: 180000, milestoneViews: 80000000, mainMileViews:100000000, divId: 'video7' , NextMile:'Est. Date for 80M ~ ', NextMileMain:'Est. Date for 100M ~ '},
        { videoId: 'K0xFPQ2CX5E', dailyViews: 60000, milestoneViews: 15000000, mainMileViews:20000000, divId: 'video9' ,NextMile:'Est. Date for 15M ~ ', NextMileMain:'Est. Date for 20M ~ '},
        { videoId: 'RmTq3cJqyCo', dailyViews: 15000, milestoneViews: 20000000, mainMileViews:50000000, divId: 'video14' ,NextMile:'Est. Date for 20M ~ ', NextMileMain:'Est. Date for 50M ~ '},
        { videoId: 'FcQ6oB1JPiA', dailyViews: 20000, milestoneViews: 15000000, mainMileViews:50000000, divId: 'video12' ,NextMile:'Est. Date for 15M ~ ', NextMileMain:'Est. Date for 50M ~ '},
